...
function Project({ dir, template }) {
    ...
    return (react_1.default.createElement(ink_1.Box, { flexDirection: "column" },
        react_1.default.createElement(Wizard_1.Wizard, { step: currentStep },
            ...
            react_1.default.createElement(Wizard_1.Step, { index: 7, name: "Next Steps" },
                react_1.default.createElement(ink_1.Text, null,
                    "cd ",
                    project.relativePath),
                react_1.default.createElement(ink_1.Text, null, "npm run dev"),
                react_1.default.createElement(ink_1.Text, null, "Open app/game.project in Defold")))));
}
