...
const useDependencyInstall_1 = __importDefault(require("../../hooks/useDependencyInstall"));
function ProjectInstall({ dir, active, onCompletion, }) {
    const install = (0, useDependencyInstall_1.default)(dir);
    (0, react_1.useEffect)(() => {
        if (active) {
            if (install.complete) {
    ...
    if (install.isLoading) {
        return (react_1.default.createElement(ink_1.Box, { flexDirection: "row" },
            react_1.default.createElement(ink_1.Text, null,
                ...
                ' ',
                install.progress && react_1.default.createElement(ink_1.Text, { color: "grey" }, install.progress))));
    }
    else if (install.errors.length > 0) {
...
exports.default = ProjectInstall;
//# sourceMappingURL=ProjectInstall.js.map