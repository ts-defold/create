...
function Help() {
    ...
    return (react_1.default.createElement(ink_1.Box, { alignItems: "center", flexDirection: "column" },
        ...
        react_1.default.createElement(ink_1.Box, { flexDirection: "column", paddingTop: 1 },
            react_1.default.createElement(ink_markdown_1.default, { html: chalk_1.default.cyan, link: chalk_1.default.blueBright, strong: chalk_1.default.green, em: chalk_1.default.yellowBright, codespan: chalk_1.default.dim }, help))));
}
